...
df = pd.read_excel(
    r"C:\Users\anjan\Downloads\EV_downtime_prediction\EV_Charger_Downtime_Final_ML_Dataset.xlsx"
)
...
joblib.dump(rf, r"C:\Users\anjan\Downloads\EV_downtime_prediction\ev_charger_failure_model.pkl")
joblib.dump(FEATURES, r"C:\Users\anjan\Downloads\EV_downtime_prediction\model_features.pkl")
